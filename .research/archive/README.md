...
| 路徑 | 說明 | 封存原因 |
|------|------|----------|
| `handoffs/P8.json` | P8 implement 完成 | merged |
| `handoffs/P10.json` | P10 ablation 完成 | VecEnv 不合併 |
| `handoffs/SAC-R.json` | R-S0~S2 | SAC-R frozen |
| `reviews/P8-reviewed-by-cursor.md` | P8 cross-review | 歷史 |
