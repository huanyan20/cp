...
paths = {
    ...
    'TWII+h20_R2y': 'reports/milestone_3b/lightgbm_20d_rolling2yr_seed42/run_summary.json',
...
header = f"{'Period':<13} | {'TWII+h20':>10} | {'TWII+h20_R2y':>12} | {'TWII+h5':>10} | {'TWII+h10':>10}"
print(header)
print('-' * len(header))
...
for name in period_names:
    ...
    print(f'{cols[0]:<13} | {cols[1]:>10} | {cols[2]:>12} | {cols[3]:>10} | {cols[4]:>10}')
...
for label, p in paths.items():
    if not Path(p).exists():
        overall_cols.append('N/A')
        mdd_cols.append('N/A')
        cash_cols.append('N/A')
        continue
    d = json.loads(Path(p).read_text('utf-8'))
    m = d['overall']
...
print(f'{overall_cols[0]:<13} | {overall_cols[1]:>10} | {overall_cols[2]:>12} | {overall_cols[3]:>10} | {overall_cols[4]:>10}')
print(f'{mdd_cols[0]:<13} | {mdd_cols[1]:>10} | {mdd_cols[2]:>12} | {mdd_cols[3]:>10} | {mdd_cols[4]:>10}')
print(f'{cash_cols[0]:<13} | {cash_cols[1]:>10} | {cash_cols[2]:>12} | {cash_cols[3]:>10} | {cash_cols[4]:>10}')
